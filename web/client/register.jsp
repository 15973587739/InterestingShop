            ...
            <form id="register">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="text" value="" name="account" class="l_user"/></td>
                    </tr>
                    <tr height="50">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="text" value="" name="nickName" class="l_user"/></td>
                    </tr>
                    <tr height="50">
                    ...
                    <tr height="50">
                        ...
                        <td><input type="text" value="" name="idCardNo" class="l_user"/></td>
                    </tr>
                    <tr height="50">
