			...
			<table border="0" style="width: 1000px; text-align: center;"
				...
				<tr height="35">
					...
					<div style="margin-top:10px;margin-bottom: 10px;font-size: 20px;">
						<img src="${ctx}/statics/images/success.png" style="vertical-align:middle;">
                        <input type="hidden" id="flag" value="true">
						<span style="padding-left: 5px;">您已成功付款￥<span></span>${order.amount }</span>
						<span style="padding-left: 5px;">，支付订单号：<span></span>${order.orderNo }</span>
					</div>
					</td>
				</tr>
				</table>
