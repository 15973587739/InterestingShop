...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right" id="content">
            ...
            <br>
            <form action="${ctx}/manager/user?action=updateUser" method="post" id="userAdd" onsubmit="return checkUser();">
                <table border="0" class="add_tab" style="width:930px;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="135" align="right">用户姓名</td>
                        <td colspan="3" style="font-family:'宋体';">
                            <input type="text" value="${user.account}" class="add_ipt" name="account"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="${user.nickName}" class="add_ipt" name="nickName"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="${user.idCardNo}" class="add_ipt" name="idCardNo"
                                   id="idCardNo"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="${user.phone}" class="add_ipt" name="phone" id="phone"/>
                        </td>
                    </tr>
                    <tr>
