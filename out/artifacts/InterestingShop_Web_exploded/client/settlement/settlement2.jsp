    ...
    <div class="two_bg">
        ...
        <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${sessionScope.cart.shopGoodsList}" var="temp">
                <tr>
                    <td>
                        <div class="c_s_img">
                            <img src="${ctx}/files/${temp.goods.fileName}" width="73" height="73"/>
                        </div>
                            ${temp.goods.goodsName}
                    </td>
                    <td align="center">${temp.buyNum}</td>
        ...
        <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="395">${sessionScope.loginUser.nickName}</td>
                <td class="p_td">登录名称</td>
                <td>${sessionScope.loginUser.account}</td>
            </tr>
            <tr>
                <td class="p_td">手机</td>
