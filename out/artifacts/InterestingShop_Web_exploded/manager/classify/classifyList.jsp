...
<div class="i_bg bg_color">
  ...
  <div class="m_content">
    ...
    <div class="m_right" id="content">
      ...
      <p align="right">
        <a href="javascript:void(0);" onclick="toAddClassify();" class="add_b">添加分类</a>
        <br>
      </p>
      <br>
      <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
        ...
        <c:forEach items="${classifyList}" var="temp">
          <tr>
            <td width="5%"><input type="radio" value="${temp.id}" name="select" onclick="toUpdateClassifyList(this);"/></td>
            <td>${temp.classifyName}</td>
            <td>
            <c:choose>
            ...
            <td><a href="javascript:void(0);" onclick="deleteClassify(${temp.id},${temp.type});">删除</a></td>
          </tr>
        </c:forEach>
        </tbody>
      </table>
